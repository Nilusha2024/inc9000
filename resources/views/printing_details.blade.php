        ...
        <section>
            ...
            <div class="page-heading" align="center">
                ...
                <div class="col-sm-4" align="right" style="padding-top:10px;margin-bottom:10px">
                    <h4>
                        <span
                            style="color:#FFF;background-color:#AE0000;padding:10px; border-radius: 25px 0px 25px 0px;font-size:26px;margin-bottom:20px;border-bottom:0px solid #ddd;">Printing
                            Department</span>
                    </h4>
                </div>
            </div>
